...
public class BayesienneUniBiFrequenceClassifier {
	...
	public BayesienneUniBiFrequenceClassifier(List<TweetInfo> references) {
	...
	public int classify(String tweet) {
    	...
    	for(String word : words) {
    		...
    		if(exp != 0) {
    			probBiNegative *= Math.pow((num/den), exp);
    		}
    		else {
    	...
    	for(String word : words) {
    		...
    		if(exp != 0) {
    			probBiNeutral *= Math.pow((num/den), exp);
    		}
    		else {
    	...
    	for(String word : words) {
    		...
    		if(exp != 0) {
    			probBiPositive *= Math.pow((num/den), exp);
    		}
    		else {
    	...
    	for(String word : wordsRefreshed) {
    		...
    		if(exp != 0) {
    			probUniNegative *= Math.pow((num/den), exp);
    		}
    		else {
    	...
    	for(String word : wordsRefreshed) {
    		...
    		if(exp != 0) {
    			probUniNeutral *= Math.pow((num/den), exp);
    		}
    		else {
    	...
    	for(String word : wordsRefreshed) {
    		...
    		if(exp != 0) {
    			probUniPositive *= Math.pow((num/den), exp);
    		}
    		else {
